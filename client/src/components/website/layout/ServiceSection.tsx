  ...
  const mocks = [
    {
      ...
      descriptionJP:
        "タイ・インドシナにおける医療アシスタンス事業として、医療機関への支払い代行、国内外の医療搬送サポート事業を行っております。",
      descriptionEN:
    ...
    },
    {
      ...
      descriptionJP:
        "タイ・ミャンマー・ラオスにて医療アシスタンスを提供しております。日本語通訳が、現地でのキャッシュレス受診をサポートいたします。",
      descriptionTH:
    ...
    },
    {
      ...
      descriptionJP:
        "タイでの各種ビザ・ワークパーミット取得代行を行っております。お気軽にご相談ください。",
      descriptionTH:
    ...
    },
    {
      ...
      descriptionJP:
        "Blue Medical Japan は日本国内の医療機関と提携し、外国人患者様向けメディカルツーリズムをご案内します。",
      descriptionTH:
