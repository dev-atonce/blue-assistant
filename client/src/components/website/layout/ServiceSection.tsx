  ...
  const mocks = [
    {
      ...
      descriptionTH: "タイ・インドシナにおける医療アシスタンス事業として、医療機関への支払い代行、国内外の医療搬送サポート業事業を行っております。",
      descriptionEN: "タイ・インドシナにおける医療アシスタンス事業として、医療機関への支払い代行、国内外の医療搬送サポート業事業を行っております。",
    ...
    {
      serviceNameTH: "ビザ・ワークパーミット取得代行h",
