...
//       <div className="mx-auto container xl:px-4 2xl:px-0 flex justify-between">
...
export default function Footer({ logo, contact, colors, owner, lng}: any) {
        ...
        <div className="container px-4 mx-auto pt-4">
          <div className=" border-b border-white/60 py-5 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Logo img={logo} />
              <div>
                <p className="text-2xl">{owner.name.en}
                </p>
                <p>{owner.name.th}</p>
              </div>
            </div>
