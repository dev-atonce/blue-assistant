    ...
    <div className="grid grid-cols-1 gap-6 text-[#333333] font-medium">
      <div className="">
        ...
        <div className="py-4 md:py-10 border-b-2 border-slate-200 ">
          <FadeHeading text="◎査証（ビザ）が必要・不要な国一覧" heading="2" />
          <div className="text-sm">
            <ul className="pl-6 list-disc">
              <li>日本国籍で一般旅券を所持されている方の条件になります。</li>
              <li>
            ...
            <div className="table-two border border-slate-300">
              <table className="text-xs table-auto">
                <tbody>
                  ...
                  <tr>
                    <td className="border border-slate-300 py-3 ">インド</td>
                  ...
                  <tr>
                    <td className="border border-slate-300 py-3 ">タイ王国</td>
                    <td className="border border-slate-300 py-3 ">▲</td>
                    <td className="border border-slate-300 py-3 ">
                  ...
                  <tr>
                    <td className="border border-slate-300 py-3 ">大韓民国</td>
                    <td className="border border-slate-300 py-3 ">×</td>
                    <td className="border border-slate-300 py-3 ">
                  ...
                  <tr>
                    <td className="border border-slate-300 py-3 ">台湾</td>
                    <td className="border border-slate-300 py-3 ">×</td>
                    <td className="border border-slate-300 py-3 ">
                      90泊91日以内の滞在は査証不要。
                      <br />
                  ...
                  <tr>
                    <td className="border border-slate-300 py-3 ">中国</td>
                    <td className="border border-slate-300 py-3 ">×</td>
                    <td className="border border-slate-300 py-3 ">
                      15日以内の滞在は査証不要。
                    </td>
                  ...
                  <tr>
                    <td className="border border-slate-300 py-3 ">ネパール</td>
                    <td className="border border-slate-300 py-3 ">○</td>
                    <td className="border border-slate-300 py-3 ">
