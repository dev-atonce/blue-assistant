    ...
    <div className="grid grid-cols-1 gap-10 text-[#333333] font-medium mb-20">
      ...
      <div>
        ...
        <div
          ...
          className="pt-18 mt-[-60px] flex flex-col gap-2"
        >
        ...
        <div id="surgery" className="pt-16 flex flex-col gap-2">
        ...
        <div id="orthopedics" className="pt-16 flex flex-col gap-2">
        ...
        <div id="rehabilitation" className="pt-16 flex flex-col gap-2">
        ...
        <div id="ophthalmology" className="pt-16 flex flex-col gap-2">
        ...
        <div id="otolaryngology-ent" className="pt-16 flex flex-col gap-2">
        ...
        <div id="emergency-medicine" className="pt-16 flex flex-col gap-2">
        ...
        <div id="health-check-ups" className="pt-16 flex flex-col gap-2">
        ...
        <div id="other-information" className="pt-16 flex flex-col gap-2">
  ...
  return (
    <div className="grid grid-cols-1 gap-10 text-[#333333] font-medium mb-20 text-sm">
      <div className="border-b-2 pb-15 border-[rgb(219,219,219)]">
        ...
        <p className="text-md ">
          各専門科の利用可能性や治療範囲は、医療機関によって異なる場合があります。詳細については、各国のジャパニーズメディカルデスク（JMD）にお問い合わせください。
        </p>
      </div>
      <div>
        ...
        <div id="surgery" className="pt-16 flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <p className="">
              <span className="font-bold">症状: </span>{" "}
              切り傷、やけど、骨折、手術が必要な状態、皮膚の腫瘍やできものなど。
            </p>
          </div>
          <div className="flex gap-2">
            <p className="">
        ...
        <div id="emergency-medicine" className="pt-16 flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <div>
              <p className="">
                <span className="font-bold">対応: </span>{" "}
                生命の危険がある緊急事態に迅速に対応します。24時間体制で、初期治療から専門医への引き継ぎまでを行います。
              </p>
              <p className="text-[#FF4E4E]">
        ...
        <div id="other-information" className="pt-16 flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <p className=" ">
              各専門診療科の有無、治療内容については各医療機関にて異なりますため、詳しくは各国のジャパニーズメディカルデスク（JMD）へお問い合わせください。
            </p>
          </div>
        </div>
      </div>
