        ...
        <div id="emergency-medicine" className="mt-10 flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            ...
            <div>
              ...
              <p className="font-thin"><span className="font-thin text-[#FF4E4E]">Note: </span> Emergency departments often provide temporary first aid, so you may need to follow up with a specialist the next day or during regular hours.</p>
            </div>
...
const ContentJP = () => {
  return (
    <div className="grid grid-cols-1 gap-10 text-[#333333] font-medium mb-20">
      <div className="border-b-2 pb-15 border-[#DBDBDB]">
        <h1 className="mt-20 text-[48px] text-[#3562AE]">医療部門ガイド</h1>
        <div className="grid grid-cols-12 gap-5 py-20  text-slate-600 font-semibold">
          <Link
            href="/department-guide#internal-medicine"
            className="bg-[#FCFCFC] py-5 border rounded-3xl shadow-lg flex flex-col justify-center items-center gap-5 col-span-6 md:col-span-4"
        ...
        <p className="text-md font-thin">各専門科の利用可能性や治療範囲は、医療機関によって異なる場合があります。詳細については、各国の日本医療デスク（JMD）にお問い合わせください。</p>
      </div>
      <div>
        <h1 className="text-[48px] text-[#3562AE]">症状別医療部門ガイド</h1>
        <div id="internal-medicine" className="mt-10 flex flex-col gap-2">
          <h2 className="text-2xl">内科</h2>
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <p className="font-thin"><span className="font-bold">症状: </span> 発熱、咳、のどの痛み、胃痛、腹痛、疲労感、めまい、高血 圧、糖尿病の管理など。</p>
          </div>
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <p className="font-thin"><span className="font-bold">対応: </span> 内科では、一般的な風邪やインフルエンザ、胃腸のトラブル、 慢性疾患など幅広い症状に対応します。予防接種も行っています。</p>
          </div>
        </div>
        <div id="surgery" className="mt-10 flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <p className="font-thin"><span className="font-bold">症状: </span> 切り傷、やけど、骨折、手術が必要な状態、皮膚の腫瘍やでき ものなど。</p>
          </div>
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <p className="font-thin"><span className="font-bold">対応: </span> 外科では、外傷や手術が必要な病状に対応します。緊急処置や 術後のケアも含まれます。</p>
          </div>
        </div>
        <div id="orthopedics" className="mt-10 flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <p className="font-thin"><span className="font-bold">症状: </span> 関節痛、筋肉痛、骨折、捻挫、スポーツ障害、リウマチなど。</p>
          </div>
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <p className="font-thin"><span className="font-bold">対応: </span> 整形外科は、骨や関節、筋肉のトラブルに特化しています。診 断から治療、リハビリまで包括的にサポートします。</p>
          </div>
        </div>
        <div id="rehabilitation" className="mt-10 flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <p className="font-thin"><span className="font-bold">症状: </span> など。 手術後の回復、慢性的な腰痛や肩こり、スポーツ後のリハビリ</p>
          </div>
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <p className="font-thin"><span className="font-bold">対応: </span> リハビリテーション科では、身体機能の回復や改善を目指し、 個々の状態に応じたリハビリプランを提供します。</p>
          </div>
        </div>
        <div id="ophthalmology" className="mt-10 flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <p className="font-thin"><span className="font-bold">症状: </span> 視力低下、目の痛み、かすみ目、結膜炎、白内障、緑内障な ど。</p>
          </div>
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <p className="font-thin"><span className="font-bold">対応: </span> 眼科では、視力検査や目の健康診断、目の病気の治療を行いま す。</p>
          </div>
        </div>
        <div id="ophthalmology-ent" className="mt-10 flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <p className="font-thin"><span className="font-bold">症状: </span> 耳鳴り、難聴、鼻づまり、のどの痛み、花粉症、扁桃炎など。</p>
          </div>
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <p className="font-thin"><span className="font-bold">対応: </span> 耳鼻咽喉科は、耳、鼻、のどのトラブルに特化しています。アレルギーの診断や治療も行って います。</p>
          </div>
        </div>
        <div id="emergency-medicine" className="mt-10 flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <p className="font-thin"><span className="font-bold">症状: </span> 夜間に発症した病気や、急な怪我や事故、急性の胸痛、呼吸困難、意識喪失、重篤なアレルギ 一反応、中毒など。</p>
          </div>
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <div>
              <p className="font-thin"><span className="font-bold">対応: </span> 救急科では、生命の危険がある緊急事態に迅速に対応します。24時間体制で、初期治療から専 門医への引き継ぎまでを行います。</p>
              <p className="font-thin"><span className="font-thin text-[#FF4E4E]">注意: </span> 土救急外来では一時的な応急処置を実施することも多いため、翌日あるいは日中などに専門医 による再診をしていただく場合もございます。</p>
            </div>
        ...
        <div id="health-check-ups" className="mt-10 flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <p className="font-thin"><span className="font-bold">症状: </span> Regular health checks, early disease detection, health status confirmation. Also conducted for license renewals or work permit renewals.</p>
          </div>
          <div className="flex gap-2">
            <Image className="object-contain object-top" src={"/img/jmd/department-guide/icon-guide.png"} alt="Internall Medicine" width={25} height={25} />
            <p className="font-thin"><span className="font-bold">対応: </span> Health check-ups involve comprehensive health evaluations through blood tests, urine tests, chest X-rays, ECGs, etc. Referrals to specialists are made as needed.</p>
          </div>
        </div>
        <div id="other-information" className="mt-10 flex flex-col gap-2">
