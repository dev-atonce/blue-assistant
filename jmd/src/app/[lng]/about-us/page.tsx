            ...
            <div className="text-sm text-blue-950 ">
              ...
              <div className="p-4 border border-blue-400 rounded-lg mt-6">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <ul className="list-disc pl-8">
                    <li>
                      日本出国後90日（または3か月）以内に発生した病気やけがについて、保険をご利用いただけます。　
                    </li>
                    <li>
                      カードの種類によっては、出国前に旅行代金のカード決済が必要など、利用条件がございますのでご注意ください。
                    </li>
                    <li>
                      クレジットカード会社への保険照会の際、お時間がかかる場合がございます。
                    </li>
                    <li>
                      お時間がある場合は、事前にご自身でクレジットカード会社のコールセンターへご連絡いただくと、手続きがよりスムーズです。
                    </li>
                  </ul>
                  <p>
                    ※適用期間や利用条件はカード会社の規定により異なりますので、事前にご確認をおすすめいたします。
                  </p>
                </div>
                {/* <FadeHeading
