        ...
        <>
            ...
            <div className="section-3 mb-6">
                ...
                <div className="p-4 rounded-lg border-2  border-gray-100">
                    <div className="grid grid-cols-12 gap-4">
                        <div className="col-span-12 lg:col-span-4">
                            <label htmlFor="interest_job_1" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">อันดับแรก</label>
                        ...
                        <div className="col-span-12 lg:col-span-4">
                            <label htmlFor="interest_job_2" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">อันดับที่สอง</label>
                        ...
                        <div className="col-span-12 lg:col-span-4">
                            <label htmlFor="interest_job_3" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">อันดับที่สาม</label>
                        ...
                        <div className="col-span-12 lg:col-span-4">
                            <label htmlFor="location" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">สถานที่</label>
                            <select title="location" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                name="location"
                                value={itemState.location}
                                onChange={setItemState}
                                required
                            >
                                <option className="text-body disabled hidden dark:text-bodydark">จังหวัด</option>
            ...
            <div className="grid grid-cols-12 gap-4 mb-6">
                <div className="xl:col-span-6 xl:col-start-7 lg:col-span-6 lg:col-start-7 col-span-12">
                    <label htmlFor="remark" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Remark</label>
                    <textarea title="รายละเอียด" rows={5} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        name="remark"
